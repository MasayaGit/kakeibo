...
class __TwigTemplate_a40f3114400b2e390eed7285bf4d768cf4ca31ee9c2e12d3a2602019f367c96b extends \Twig\Template
{
    private $source;
...
$context["log"], "priorityName", [], "any", false, false, false, 206) == "WARNING")) ? ("status-warning") : (""))))));
                ...
                echo "
                    <td class=\"font-normal\">";
                // line 226
                echo $context["helper"]->macro_render_log_message((isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 226, $this->source); })()), twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 226), $context["log"]);
                echo "</td>
                </tr>
            ";
                ++$context['loop']['index0'];
...
{% macro render_log_message(category, log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "/Users/info/PhpstormProjects/kakeibo/vendor/symfony/web-profiler-bundle/Resources/views/Collector/logger.html.twig");
    }
}
