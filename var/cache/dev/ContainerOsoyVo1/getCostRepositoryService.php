...
// Returns the private 'App\Repository\CostRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CostRepository.php';

return $this->privates['App\\Repository\\CostRepository'] = new \App\Repository\CostRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
